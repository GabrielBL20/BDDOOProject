...
export default function FutbolStats() {
  ...
  const leagueData = {
    laliga: [
      { pos: 1, team: 'Barcelona', pj: 25, g: 19, e: 4, p: 2, gf: 57, gc: 19, dg: 38, pts: 61 },
      { pos: 2, team: 'Real Madrid', pj: 25, g: 18, e: 5, p: 2, gf: 52, gc: 16, dg: 36, pts: 59 },
      { pos: 3, team: 'Atlético Madrid', pj: 25, g: 16, e: 3, p: 6, gf: 45, gc: 24, dg: 21, pts: 51 },
      { pos: 4, team: 'Real Sociedad', pj: 25, g: 13, e: 6, p: 6, gf: 38, gc: 25, dg: 13, pts: 45 },
      { pos: 5, team: 'Villarreal', pj: 25, g: 12, e: 6, p: 7, gf: 40, gc: 31, dg: 9, pts: 42 }
    ],
    premier: [
      { pos: 1, team: 'Man City', pj: 25, g: 18, e: 4, p: 3, gf: 59, gc: 21, dg: 38, pts: 58 },
      { pos: 2, team: 'Liverpool', pj: 25, g: 17, e: 6, p: 2, gf: 55, gc: 19, dg: 36, pts: 57 },
      { pos: 3, team: 'Arsenal', pj: 25, g: 16, e: 5, p: 4, gf: 52, gc: 21, dg: 31, pts: 53 },
      { pos: 4, team: 'Tottenham', pj: 25, g: 14, e: 5, p: 6, gf: 49, gc: 32, dg: 17, pts: 47 },
      { pos: 5, team: 'Chelsea', pj: 25, g: 13, e: 5, p: 7, gf: 45, gc: 30, dg: 15, pts: 44 }
    ],
    seriea: [
      { pos: 1, team: 'Inter', pj: 25, g: 19, e: 4, p: 2, gf: 55, gc: 14, dg: 41, pts: 61 },
      { pos: 2, team: 'Milan', pj: 25, g: 17, e: 5, p: 3, gf: 50, gc: 22, dg: 28, pts: 56 },
      { pos: 3, team: 'Napoli', pj: 25, g: 15, e: 6, p: 4, gf: 48, gc: 20, dg: 28, pts: 51 },
      { pos: 4, team: 'Juventus', pj: 25, g: 14, e: 5, p: 6, gf: 42, gc: 25, dg: 17, pts: 47 },
      { pos: 5, team: 'Atalanta', pj: 25, g: 13, e: 5, p: 7, gf: 45, gc: 29, dg: 16, pts: 44 }
    ],
    bundesliga: [
      { pos: 1, team: 'Bayern Munich', pj: 25, g: 20, e: 3, p: 2, gf: 69, gc: 20, dg: 49, pts: 63 },
      { pos: 2, team: 'Dortmund', pj: 25, g: 17, e: 3, p: 5, gf: 56, gc: 29, dg: 27, pts: 54 },
  ...
  const topPlayers = [
    { name: 'Robert Lewandowski', team: 'Barcelona', goals: 23, image: '/api/placeholder/80/80' },
    { name: 'Erling Haaland', team: 'Man City', goals: 21, image: '/api/placeholder/80/80' },
    { name: 'Kylian Mbappé', team: 'Real Madrid', goals: 19, image: '/api/placeholder/80/80' }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center bg-blue-700/50 rounded-full px-3 py-1">
                ...
                <input type="text" placeholder="Buscar..." className="bg-transparent border-none focus:outline-none text-white placeholder-blue-200 ml-2 w-36" />
              </div>
          ...
          {isMenuOpen && (
            <nav className="md:hidden mt-4 pb-4 flex flex-col space-y-2 animate-fadeIn">
              <a href="#" className="font-medium hover:bg-blue-700 rounded p-2 transition">Inicio</a>
              <a href="#" className="font-medium hover:bg-blue-700 rounded p-2 transition">Ligas</a>
              <a href="#" className="font-medium hover:bg-blue-700 rounded p-2 transition">Equipos</a>
              <a href="#" className="font-medium hover:bg-blue-700 rounded p-2 transition">Jugadores</a>
              <a href="#" className="font-medium hover:bg-blue-700 rounded p-2 transition">Noticias</a>
              <div className="flex items-center bg-blue-700/50 rounded-full px-3 py-2 mt-2">
                <Search className="h-4 w-4 text-blue-200" />
                <input type="text" placeholder="Buscar..." className="bg-transparent border-none focus:outline-none text-white placeholder-blue-200 ml-2 w-full" />
              </div>
            </nav>
          )}
        </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 animate-fadeInUp animation-delay-200">
              Análisis detallados, clasificaciones actualizadas y todo lo que necesitas saber sobre el mundo del fútbol.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeInUp animation-delay-400">
              <a href="#" className="inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg text-center">
                Explorar Estadísticas
              </a>
              <a href="#" className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg text-center">
                Partidos en Vivo
              </a>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {stats.map((stat, index) => (
              <div key={index} className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1">
      ...
      <section className="py-12 bg-gradient-to-br from-blue-800 to-blue-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">Partidos en Directo</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {liveMatches.map((match) => (
              <div key={match.id} className={`bg-blue-700/30 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 backdrop-blur-sm ${match.highlight ? 'ring-2 ring-yellow-400' : ''}`}>
                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-4">
                    <div className="text-center w-2/5">
                      ...
                      <div className="font-medium truncate">{match.homeTeam}</div>
                    </div>
                    ...
                    <div className="text-center w-2/5">
                      ...
                      <div className="font-medium truncate">{match.awayTeam}</div>
                    </div>
                  </div>
          ...
          <div className="text-center mt-8">
            <a href="#" className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-bold py-2 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-1">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10 text-blue-900">Clasificaciones</h2>
          
          <div className="mb-6 flex flex-wrap justify-center gap-2">
            <button 
              onClick={() => setActiveTab('laliga')}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'laliga' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              La Liga
            </button>
            <button 
              onClick={() => setActiveTab('premier')}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'premier' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Premier League
            </button>
            <button 
              onClick={() => setActiveTab('seriea')}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'seriea' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Serie A
            </button>
            <button 
              onClick={() => setActiveTab('bundesliga')}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeTab === 'bundesliga' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
            >
              Bundesliga
            </button>
          </div>
              ...
              <table className="min-w-full">
                ...
                <tbody>
                  {leagueData[activeTab].map((team, index) => (
                    <tr key={index} className={`border-b border-gray-200 hover:bg-blue-50 transition ${index < 4 ? 'bg-blue-50/50' : ''}`}>
                      <td className={`py-3 px-4 font-medium ${index < 4 ? 'text-blue-600' : ''}`}>{team.pos}</td>
      ...
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4 text-blue-900">Goleadores Destacados</h2>
          <p className="text-center text-gray-600 mb-10 max-w-2xl mx-auto">
            Los jugadores más letales frente a portería esta temporada con estadísticas actualizadas.
          </p>
                ...
                <div className="p-6 flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1 flex items-center">
                      <span className="text-blue-600 font-bold text-xl">{player.goals}</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Tu fuente más completa de estadísticas y análisis de fútbol con cobertura global y actualizaciones en tiempo real.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li><a href="#" className="hover:text-white transition">Ligas</a></li>
                <li><a href="#" className="hover:text-white transition">Equipos</a></li>
                <li><a href="#" className="hover:text-white transition">Jugadores</a></li>
